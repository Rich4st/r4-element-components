              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys(unref(ElIcons)), (item, index2) => {
                return openBlock(), createElementBlock("div", {
                  ...
                  createElementVNode("div", null, [
                    (openBlock(), createBlock(resolveDynamicComponent(`el-icon-${unref(toLine)(item)}`), { class: "icon" }))
                  ]),
...
var chooseIcon = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-722079e7"]]);
var index = {
  install(app) {
    app.component("ChooseIconVue", chooseIcon);
  }
};
