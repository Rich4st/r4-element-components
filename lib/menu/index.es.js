...
import { defineComponent, resolveComponent, openBlock, createBlock, withCtx, createVNode, createElementBlock, Fragment, renderList, resolveDynamicComponent, unref, createCommentVNode, createElementVNode, toDisplayString, isVNode } from "vue";
const toLine = (value) => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_el_aside, { width: "auto" }, {
        default: withCtx(() => [
          createVNode(_component_el_menu, {
            ...
            "active-text-color": __props.activeTextColor,
            ...
            default: withCtx(() => [
              (openBlock(true), createElementBlock(Fragment, null, renderList(__props.data, (item, index2) => {
                return openBlock(), createElementBlock(Fragment, { key: index2 }, [
                  item.children && item.children.length ? (openBlock(), createBlock(_component_el_sub_menu, {
                    key: 0,
                    index: item.index
                  }, {
                    title: withCtx(() => [
                      item.icon ? (openBlock(), createBlock(resolveDynamicComponent(`el-icon-${unref(toLine)(item.icon)}`), { key: 0 })) : createCommentVNode("", true),
                      createElementVNode("span", null, toDisplayString(item.name), 1)
                    ]),
                    default: withCtx(() => [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(item.children, (item1, index1) => {
                        return openBlock(), createBlock(_component_el_menu_item, { key: index1 }, {
                          default: withCtx(() => [
                            item1.icon ? (openBlock(), createBlock(resolveDynamicComponent(`el-icon-${unref(toLine)(item1.icon)}`), { key: 0 })) : createCommentVNode("", true),
                            createElementVNode("span", null, toDisplayString(item1.name), 1)
                          ]),
                          _: 2
                        }, 1024);
                      }), 128))
                  ...
                  !item.children || !item.children.length ? (openBlock(), createBlock(_component_el_menu_item, {
                    key: 1,
                    index: item.index
                  }, {
                    default: withCtx(() => [
            ...
            _: 1
          }, 8, ["mode", "background-color", "text-color", "active-text-color", "router", "collapse", "default-active"])
        ]),
        _: 1
      });
    };
...
var menu = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ab4e0284"]]);
  ...
  setup(props, ctx) {
    let renderMenu = (data) => {
      return data.map((item) => {
        item.i = Icons[item.icon];
        let slots = {
          title: () => {
            return createVNode(Fragment, null, [createVNode(item.i, null, null), createVNode("span", null, [item.name])]);
          }
        };
        ...
        return createVNode(resolveComponent("el-menu-item"), {
          ...
          default: () => [createVNode(item.i, null, null), createVNode("span", null, [item.name])]
        });
      });
    };
    return () => {
      let _slot;
      return createVNode(resolveComponent("el-menu"), null, _isSlot(_slot = renderMenu(props.data)) ? _slot : {
        default: () => [_slot]
      });
    };
  }
