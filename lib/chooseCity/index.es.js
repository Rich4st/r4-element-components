import { defineComponent, ref, onMounted, resolveComponent, openBlock, createBlock, withCtx, createElementVNode, toDisplayString, createVNode, normalizeClass, createElementBlock, Fragment, renderList } from "vue";
var c = {
  cities: {
    A: [{
      id: 56,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: emits }) {
    ...
    const radioVal = ref("\u57CE\u5E02");
    const citys = ref(c.cities);
    const provinces = ref(p);
    const selectVal = ref("");
    const cities = ref([]);
    const getCity = (item) => {
    ...
    const getCityFromProvince = (item) => {
      city.value = item;
      visible.value = false;
      emits("update-city", item);
    };
      ...
      return openBlock(), createBlock(_component_el_popover, {
        ...
        reference: withCtx(() => [
          createElementVNode("div", {
            ...
            createElementVNode("div", null, toDisplayString(city.value), 1),
        ...
        default: withCtx(() => [
          createElementVNode("div", _hoisted_2, [
                ...
                createVNode(_component_el_col, { span: 8 }, {
                  default: withCtx(() => [
                    createVNode(_component_el_radio_group, {
                      ...
                      default: withCtx(() => [
                        createVNode(_component_el_radio_button, { label: "\u57CE\u5E02" }),
                        createVNode(_component_el_radio_button, { label: "\u7701\u4EFD" })
                      ]),
                      _: 1
                    }, 8, ["modelValue"])
                  ]),
                ...
                createVNode(_component_el_col, {
                  ...
                  default: withCtx(() => [
                    createVNode(_component_el_select, {
                      ...
                      "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => selectVal.value = $event),
                      placeholder: "\u8BF7\u9009\u62E9\u57CE\u5E02",
                      filterable: "",
                      ...
                      default: withCtx(() => [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(cities.value, (item) => {
                          return openBlock(), createBlock(_component_el_option, {
                            ...
                            default: withCtx(() => [
                              ...
                              createElementVNode("span", _hoisted_4, toDisplayString(item.spell), 1)
                            ]),
                            _: 2
                          }, 1032, ["label", "value"]);
                        }), 128))
            ...
            radioVal.value === "\u57CE\u5E02" ? (openBlock(), createElementBlock("div", _hoisted_5, [
              (openBlock(true), createElementBlock(Fragment, null, renderList(citys.value, (value, key) => {
                return openBlock(), createElementBlock("div", {
                  class: "city-item",
                  key,
                  onClick: ($event) => onLetterClick(key)
                }, [
                  createElementVNode("div", null, toDisplayString(key), 1)
                ], 8, _hoisted_6);
              }), 128)),
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(provinces.value, (value, key) => {
                return openBlock(), createElementBlock("div", {
                  class: "province-item",
                  key,
                  onClick: ($event) => onLetterClick(key)
                        ...
                        return openBlock(), createBlock(_component_el_row, {
                          ...
                          default: withCtx(() => [
                            createVNode(_component_el_col, { span: 3 }, {
                              default: withCtx(() => [
                                createElementVNode("div", null, toDisplayString(item1.name) + ": ", 1)
                              ]),
                              _: 2
                            }, 1024),
                            createVNode(_component_el_col, {
                              ...
                              default: withCtx(() => [
                                (openBlock(true), createElementBlock(Fragment, null, renderList(item1.data, (item2, index22) => {
                                  return openBlock(), createElementBlock("div", {
                                    ...
                                    key: index22,
                                    onClick: ($event) => getCityFromProvince(item2)
                                  }, [
                                    createElementVNode("div", null, toDisplayString(item2), 1)
                                  ], 8, _hoisted_10);
                                }), 128))
                              ]),
                              _: 2
...
var chooseCity = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6c3e3a40"]]);
var index = {
  install(app) {
