import { defineComponent, computed, ref, watch, onMounted, resolveComponent, resolveDirective, openBlock, createElementBlock, withDirectives, createBlock, mergeProps, withCtx, Fragment, renderList, createVNode, createElementVNode, withModifiers, renderSlot, toDisplayString, createCommentVNode, resolveDynamicComponent, unref, normalizeStyle } from "vue";
const toLine = (value) => {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  emits: ["confirm-edit", "cancel-edit", "update:edit-row-index", "update:current-page", "update:page-size"],
  setup(__props, { emit: emits }) {
    const props = __props;
    const isLoading = computed(() => !props.data || !props.data.length);
    const currentEditVal = ref("");
    const onEditClick = (scope) => {
      currentEditVal.value = scope.$index + scope.column.id;
    };
    const onConfirmEdit = (scope) => {
      currentEditVal.value = "";
      emits("confirm-edit", scope);
    };
    const onCancelEdit = (scope) => {
      currentEditVal.value = "";
      emits("cancel-edit", scope);
    };
    const tableData = ref(lodash.exports.cloneDeep(props.data));
    ...
    watch(() => props.data, (val) => {
      tableData.value = lodash.exports.cloneDeep(val);
      tableData.value.map((item) => {
        item.rowEdit = false;
      });
    }, { deep: true });
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.options, (item, index2) => {
              return openBlock(), createBlock(_component_el_table_column, {
                ...
                default: withCtx((scope) => [
                  scope.row.rowEdit && !item.action ? (openBlock(), createBlock(_component_el_input, {
                    key: 0,
                    ...
                    scope.$index + scope.column.id === currentEditVal.value ? (openBlock(), createElementBlock("div", _hoisted_1, [
                      ...
                      createElementVNode("div", _hoisted_2, [
                        createVNode(_component_el_icon_check, {
                          class: "check",
                          onClick: withModifiers(($event) => onConfirmEdit(scope), ["stop"])
                        }, null, 8, ["onClick"]),
                        createVNode(_component_el_icon_close, {
                          class: "close",
                          onClick: withModifiers(($event) => onCancelEdit(scope), ["stop"])
                        }, null, 8, ["onClick"])
                      ])
                    ])) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                      item.action && !scope.row.rowEdit ? renderSlot(_ctx.$slots, "action", {
                        key: 0,
                        scope
                      }, void 0, true) : item.slot ? renderSlot(_ctx.$slots, item.slot, {
                        key: 1,
                        scope
                      }, void 0, true) : (openBlock(), createElementBlock("span", _hoisted_3, toDisplayString(scope.row[item.prop]), 1)),
                      item.action && scope.row.rowEdit ? renderSlot(_ctx.$slots, "editRow", { key: 3 }, void 0, true) : createCommentVNode("", true),
                      item.editable ? (openBlock(), createBlock(resolveDynamicComponent(`el-icon-${unref(toLine)(__props.editIcon)}`), {
                        key: 4,
                        class: "edit",
                        onClick: withModifiers(($event) => onEditClick(scope), ["stop"])
                      }, null, 8, ["onClick"])) : createCommentVNode("", true)
                    ], 64))
                  ], 64))
                ]),
                _: 2
              }, 1032, ["label", "prop", "align"]);
            }), 128))
          ]),
          _: 3
        }, 16, ["data", "element-loading-text", "element-loading-spinner", "element-loading-background", "element-loading-svg"])), [
          [_directive_loading, unref(isLoading)]
        ]),
        __props.isPagination ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: "pagination",
          style: normalizeStyle({ justifyContent: __props.paginationAlign })
        }, [
...
var table = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5a27fb3a"]]);
var index = {
  install(app) {
